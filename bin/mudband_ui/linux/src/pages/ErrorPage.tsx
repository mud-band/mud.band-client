            ...
            <div className="max-w-md w-full p-6 rounded-lg border-destructive/20">
                ...
                <div className="space-y-4">
                    <p className="text-muted-foreground">
                        Failed to connect to `mudband_service` process via Unix socket.
                        Please check the following:
                    </p>
                    
                    <ul className="list-disc ml-4 space-y-2 text-muted-foreground">
                        <li>Verify that the `mudband_service` process is running</li>
                        <li>Check if socket permissions are properly configured</li>
