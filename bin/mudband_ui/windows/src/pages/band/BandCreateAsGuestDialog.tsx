...
interface BandCreateAsGuestDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess: () => void;
}

export default function BandCreateAsGuestDialog({ open, onOpenChange, onSuccess }: BandCreateAsGuestDialogProps) {
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Create Band as Guest</DialogTitle>
            <DialogDescription>
              Create a new band as a guest user.
            </DialogDescription>
          </DialogHeader>
